 ...
 */
final class Version20250218192814 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande CHANGE paiment paiment LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande CHANGE paiment paiment LONGTEXT NOT NULL COMMENT \'(DC2Type:simple_array)\'');
