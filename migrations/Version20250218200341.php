 ...
 */
final class Version20250218200341 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP featured_image_id, CHANGE image image VARCHAR(255) DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE article ADD featured_image_id INT DEFAULT NULL, CHANGE image image VARCHAR(255) NOT NULL');
